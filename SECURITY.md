...
DevLens is currently in early alpha development.

Security fixes and updates will be provided for the latest active development version.
...
- prepare a fix
- responsibly disclose the resolution if necessary
...
- publishing exploit details before fixes
